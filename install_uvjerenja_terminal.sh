...
DEFAULT_ADMIN_PASSWORD_HASH="pbkdf2_sha256:310000:75766a6572656e6a612d61646d696e21:227ece75def6723c90ab3b7ba22e4a3d68a986e51d62c54f02cc9614f03e53fa"
usage() {
  cat <<USAGE
...
POTVRDE_ADMIN_PASSWORD_HASH="$DEFAULT_ADMIN_PASSWORD_HASH"
...
ensure_env_setting "POTVRDE_ADMIN_PASSWORD_HASH" "$DEFAULT_ADMIN_PASSWORD_HASH"
...
# Existing env values are configuration owned by the installation. Updates may
# append newly introduced settings, but never rewrite a value that is already
# present (including repository paths, tokens, printer names and user IDs).
