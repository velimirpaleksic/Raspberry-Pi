...
class ReviewScreen(tk.Frame):
    ...
    def __init__(self, parent, manager=None):
        ...
        confirmation_font = ("Arial", max(30, int(round(30 * ui_scale))), "bold")
        title_font = ("Arial", max(20, int(round(20 * ui_scale))), "bold")
        ...
        tk.Label(
            content,
            text="ПОТВРДИ ИНФОРМАЦИЈЕ",
            font=confirmation_font,
            bg="#f5f5f5",
            fg="#b00020",
        ).pack(pady=(8, 2))
        tk.Label(content, text="ПРОВЈЕРИТЕ ПОДАТКЕ", font=title_font, bg="#f5f5f5", fg="#111111").pack(pady=(0, 10))
