...
TELEGRAM_REMOTE_COMMANDS_ENABLED = _env_bool("POTVRDE_TELEGRAM_REMOTE_COMMANDS_ENABLED", True)
...
UPDATE_REPO_URL = _env("POTVRDE_UPDATE_REPO_URL", DEFAULT_UPDATE_REPO_URL)
UPDATE_SOURCE_DIR = Path(_env("POTVRDE_UPDATE_SOURCE_DIR", str(Path.home() / "Raspberry-Pi"))).expanduser()
UPDATE_BRANCH = _env("POTVRDE_UPDATE_BRANCH", "")
TELEGRAM_UPDATE_COMMAND = _env("POTVRDE_UPDATE_COMMAND", "bash ./update_uvjerenja_terminal.sh")
